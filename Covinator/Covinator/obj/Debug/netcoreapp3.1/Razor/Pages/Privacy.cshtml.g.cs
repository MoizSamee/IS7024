#pragma checksum "C:\Users\vpsap\OneDrive\Documents\GitHub\IS7024\Covinator\Covinator\Pages\Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "aff3cbe8b6d4010e038a362ee948447ae9f78dbe"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"aff3cbe8b6d4010e038a362ee948447ae9f78dbe", @"/Pages/Privacy.cshtml")]
...
<p>The COVID‑19 pandemic is challenging businesses and their advisors in unprecedented ways. To protect their employees, workplaces, customers, and operations, companies must take dramatic new steps, which may include testing and collection of information about the medical condition of employees and customers, sharing of information with public health authorities, responding to government requests for information, and implementing procedures for social distancing and telecommuting or working remotely. These changes raise unique issues regarding the application of existing privacy laws and policies. Some governmental regulators are issuing guidance to help companies balance the need for public health and workplace safety with individual privacy rights, while others make clear that they do not see the pandemic as lowering the need for complete adherence to privacy laws. The following is a checklist of issues, resources for companies to consider, and steps companies can take to mitigate legal risks and ");
            WriteLiteral(@"ensure compliance with privacy regulations.</p>
...
<p> To the extent your business is considering whether to collect or examine information from individuals (employees, customers, or others) regarding COVID-19 risks, first examine your existing privacy policies to evaluate how they treat the collection of information relating to a person’s medical condition. Determine the scope of what those policies permit and how information is to be handled in light of those policies. Companies may need to amend or supplement policies to cover information relating to pandemics or COVID-19.
    ...
    Where required by applicable law, ensure there is a legitimate basis and need for the information being collected, particularly if you are operating in the European Union (EU). The GDPR requires a lawful basis for collecting personal information, and companies operating in the EU need to balance the need for public and workplace safety against individual data protection rights.4 This includes consulting the guidance");
            WriteLiteral(@" issued by particular data protection authorities regarding the handling of personal information in light of this crisis.
    ...
    Employers may ask employees who report feeling ill at wor");
            WriteLiteral(@"k, or who call in sick, questions about their symptoms to determine if they have or may have COVID-19.
    ...
    Nonetheless, measuring employees’ body temperatures and making decisions based on employees’ high-risk status involve complicated legal");
            WriteLiteral(@" issues, such as whether employees pose a “direct threat” to themselves or others. Guidance from the EEOC and California’s DFEH—though informative and persuasive authorities—is not binding on courts. Companies should seek legal advice before moving forward with these types of actions.
    ...
    Different rules may apply outside the United States. Companies should review the rules in each jurisdictio");
            WriteLiteral(@"n in which they have operations to determine what procedures they should follow with employees in that jurisdiction.4
